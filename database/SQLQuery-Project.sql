...
-- Sản phẩm
insert into tbSanPham Values('SP01',N'Bim Bim Oishi vị cà chua',N'Snack Oishi với từng miếng snack tròn thiết kế hình dạng của lát cà chua lạ mắt, gia vị đậm đà được phủ kín mặt bánh, càng ăn càng ngon',5000,4000,'BB',200)
insert into tbSanPham Values('SP02',N'Bim Bim Oishi Indo Chips',N'Snack gồm những miếng bánh phồng giòn rụm, thơm vị mực, mang lại cho bé cảm giác ngon miệng, thích thú khi ăn',5000,4000,'BB',225)
select * from tbSanPham
-- anh san pham
Delete from tbAnhSanPham
INSERT INTO tbAnhSanPham (MaSP, TenFileAnh,IdAnh)
VALUES 
('SP01', (SELECT * FROM OPENROWSET(BULK N'D:\dowlnoad2\SQL-New\anh\MSP01.jpg', SINGLE_BLOB) AS Image1),'SP01.1'),
('SP01', (SELECT * FROM OPENROWSET(BULK N'D:\dowlnoad2\SQL-New\anh\MSP01.2.jpg', SINGLE_BLOB) AS Image2),'SP01.2'),
('SP01', (SELECT * FROM OPENROWSET(BULK N'D:\dowlnoad2\SQL-New\anh\MSP01.3.jpg', SINGLE_BLOB) AS Image3),'SP01.3')

INSERT INTO tbAnhSanPham (MaSP, TenFileAnh,IdAnh)
VALUES 
('SP02', (SELECT * FROM OPENROWSET(BULK N'D:\dowlnoad2\SQL-New\anh\MSP02.jpg', SINGLE_BLOB) AS Image1),'SP02.1'),
('SP02', (SELECT * FROM OPENROWSET(BULK N'D:\dowlnoad2\SQL-New\anh\MSP02.2.jpg', SINGLE_BLOB) AS Image2),'SP02.2'),
('SP02', (SELECT * FROM OPENROWSET(BULK N'D:\dowlnoad2\SQL-New\anh\MSP02.3.jpg', SINGLE_BLOB) AS Image3),'SP02.3')
